    ...
    public partial class _ : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2022, 12, 4, 12, 57, 44, 911, DateTimeKind.Local).AddTicks(267), 1, "HP Laptop Touch your Dreams", "/images/products/1.jpg", 15000m, "HP Z Book" });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "AtCreated", "CategoryId", "Description", "ImageUrl", "Price", "ProductName" },
                values: new object[] { 2, new DateTime(2022, 12, 4, 12, 57, 44, 911, DateTimeKind.Local).AddTicks(288), 2, "Airpods for your ears", "/images/products/2.jpg", 5000m, "AirPods" });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "AtCreated", "CategoryId", "Price", "ProductName" },
                values: new object[] { 3, new DateTime(2022, 12, 4, 12, 57, 44, 911, DateTimeKind.Local).AddTicks(289), 3, 7000m, "Samsun Galaxy Note FE" });
